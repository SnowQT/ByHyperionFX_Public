...
doorList = {
	...
	[36] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},
	[37] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},
	[38] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},
	[39] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},
	[40] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},
	[41] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},
	[42] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},
	[43] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},
	[44] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},
	[45] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},		
	[46] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},		
	[47] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},		
	[48] = {freeze = true, key = "key_MIC", permission="", name = "Michaels hus"},
	[49] = {freeze = true, key = "key_DC", permission="", name = "Denise Clintons hus"},
	[50] = {freeze = true, key = "key_FR", permission="", name = "Franklins hus"},
	[51] = {freeze = true, key = "key_LMC", permission="", name = "The Lost MC klubhus"},
	...
	[68] = {freeze = true, key = "key_RS", permission="cop.keycard", name = "Retssalen"},
	[69] = {freeze = true, key = "key_RS", permission="cop.keycard", name = "Retssalen"},
	[70] = {freeze = true, key = "key_RS", permission="cop.keycard", name = "Retssalen"},
	[71] = {freeze = true, key = "key_RS", permission="cop.keycard", name = "Retssalen"}
}
