...
items["hash"] = {"Hashklump","En klump hash.",function(args) return smoke_choices end,0.05}
items["cocaine"] = {"Kokain","En pose kokain.",function(args) return smell_choices end,0.80}
items["lsd"] = {"LSD","Et frimærke med LSD.",function(args) return lsd_choices end,0.80}
items["dykkerdragt"] = {"Dykkerdragt","Tag denne dragt på, og nyd havets natur. Bestående af: Komplet dykkerdragt, dykkerbriller, svømmefødder og ilttank. VÆR OPMÆRKSOM PÅ AT DETTE KUN KAN BRUGES I VANDET!",function(args) return dykkerdragt_choices end,70.00}
