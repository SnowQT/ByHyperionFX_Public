...
cfg.hidden_transformers = {
  ...
  -- FISK
	...
	["Epsilon ultens lager"] = {
		def = {
			name="Epsilon kultens lager", -- menu name
			permissions = {"drugseller.harvest"}, -- you can add permissions
			r=200,g=0,b=0, -- color
			max_units=10,
			units_per_minute=1,
			...
			radius=12, height=5.5, -- area
			blip=true, -- Should transformer have blip
			blipid="epsilon", -- Unique id for blip
			blipicon=478,
			blipcolor=16,
			marker=false,
			markerid=0,
			markerdata={0,0,0,0,0,0,0,0}, -- sx,sy,sz,r,g,b,a,vis_distance
			recipes = {
				["Find den mystiske kasse"] = { -- action name
					description="Find kassen som våben dealeren bedte dig hente. Kommer du med den forkerte, sender han dig væk igen!", -- action description
					work=20,
					in_money=0, -- money taken per unit
					out_money=0, -- money earned per unit
					reagents={}, -- items taken per unit
		...
		positions = {
			{246.5864,371.4290,106.3245}
		},
		duration = 9000 -- 5 days (time before switching position, min 5 mins.)
	},
	...
	["FBI modem"] = {
		def = {
			name="FBI modem", -- menu name
			permissions = {"drugseller.harvest"}, -- you can add permissions
			r=0,g=200,b=0, -- color
			max_units=10,
			units_per_minute=1,
			x=0,y=0,z=0, -- pos
			radius=2.5, height=5.5, -- area
			blip=false, -- Should transformer have blip
			blipid="fbi", -- Unique id for blip
			blipicon=501,
			blipcolor=40,
			marker=false,
			markerid=0,
			markerdata={0,0,0,0,0,0,0,0}, -- sx,sy,sz,r,g,b,a,vis_distance
			recipes = {
				["Stjæl FBI modem"] = { -- action name
					description="Stjæl et modem fra FBI, til våben dealeren.", -- action description
					work=100,
					in_money=0, -- money taken per unit
					out_money=0, -- money earned per unit
					reagents={}, -- items taken per unit
		...
		positions = {
			{123.5833,-726.6961,242.1519}
		},
		duration = 9000 -- 5 days (time before switching position, min 5 mins.)
	},
	["FBI harddisk"] = {
		def = {
			name="FBI harddisk", -- menu name
			permissions = {"drugseller.harvest"}, -- you can add permissions
			r=0,g=200,b=0, -- color
			max_units=10,
			units_per_minute=1,
			...
			markerdata={0,0,0,0,0,0,0,0}, -- sx,sy,sz,r,g,b,a,vis_distance
			recipes = {
				["Stjæl en harddisk"] = { -- action name
					description="Stjæl en harddisk med informationer fra FBI, til våben dealeren.", -- action description
					work=100,
					in_money=0, -- money taken per unit
					out_money=0, -- money earned per unit
					reagents={}, -- items taken per unit
