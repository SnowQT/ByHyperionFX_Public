  ...
  while true do
    ...
    if car ~= 0 and (wasInCar or IsCar(car)) then
      ...
      if IsControlJustReleased(0, 311) then 
       beltOn = not beltOn        
        if beltOn then 
        exports.pNotify:SendNotification({text = "Sikkerhedssele <b style='color: #5DB6E5'>spændt</b>.",type = "success",timeout = (3000),layout = "bottomCenter",queue = "fart",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
         else 
        exports.pNotify:SendNotification({text = "Sikkerhedssele <b style='color: #DB4646'>løsnet</b>.",type = "success",timeout = (3000),layout = "bottomCenter",queue = "fart",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
        end
      end
