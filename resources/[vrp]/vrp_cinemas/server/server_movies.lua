...
AddEventHandler('vrp_cinema:takemovie', function (source, derp, price)
	...
	if vRP.tryFullPayment({user_id, price}) then
        ...
        TriggerClientEvent("pNotify:SendNotification", user_id,{text = {"Du har ikke råd | En billet koster ".. price..",- DKK"}, type = "error", queue = "global", timeout = 4000, layout = "centerLeft",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"},killer = true})
	end
end)
